...
public class GT_Hatch_Crafting_Integration_ME extends GT_MetaTileEntity_Hatch_InputBus
    implements IConfigurationCircuitSupport, IAddGregtechLogo, IAddUIWidgets,
    IPowerChannelState, ICraftingProvider, IGridProxyable, IDualInputHatch, ICustomNameObject, IInterfaceViewable {
    ...
    private GT_Hatch_Crafting_Integration_ME.PatternSlot[] internalInventory = new GT_Hatch_Crafting_Integration_ME.PatternSlot[MAX_PATTERN_COUNT];
    // a hash map for faster lookup of pattern slots, not necessarily all valid.
    private Map<ICraftingPatternDetails, GT_Hatch_Crafting_Integration_ME.PatternSlot> patternDetailsPatternSlotMap = new HashMap<>(MAX_PATTERN_COUNT);
    private boolean needPatternSync = true;
    private boolean justHadNewItems = false;
    private String customName = null;
    private boolean supportFluids;
    private boolean additionalConnection = false;
    public GT_Hatch_Crafting_Integration_ME(int aID, String aName, String aNameRegional,
    ...
    public GT_Hatch_Crafting_Integration_ME(String aName, int aTier, String[] aDescription,
    ...
    public MetaTileEntity newMetaEntity(IGregTechTileEntity aTileEntity) {
        return new GT_Hatch_Crafting_Integration_ME(mName, mTier, mDescriptionArray, mTextures, supportFluids);
    }
    ...
    public AENetworkProxy getProxy() {
        if (gridProxy == null) {
            gridProxy = new AENetworkProxy(this, "proxy", GT_Integration_ME_Hatch.get(1), true);
    ...
    public void loadNBTData(NBTTagCompound aNBT) {
        ...
        for (int i = 0; i < internalInventoryNBT.tagCount(); i++) {
            ...
            if (pattern != null) {
                internalInventory[patternSlot] = new GT_Hatch_Crafting_Integration_ME.PatternSlot(
                    pattern,
                    patternSlotNBT,
                    getBaseMetaTileEntity().getWorld(),
                    this::getSharedItems);
        ...
        for (GT_Hatch_Crafting_Integration_ME.PatternSlot patternSlot : internalInventory) {
            if (patternSlot != null) {
    ...
    private void onPatternChange(int index, ItemStack newItem) {
        ...
        var patternSlot = new GT_Hatch_Crafting_Integration_ME.PatternSlot(newItem, world, this::getSharedItems);
    ...
    public void getWailaNBTData(EntityPlayerMP player, TileEntity tile, NBTTagCompound tag, World world, int x, int y,
        ...
        for (Iterator<GT_Hatch_Crafting_Integration_ME.PatternSlot> it = inventories(); it.hasNext(); ) {
            var i = it.next();
    ...
    public void provideCrafting(ICraftingProviderHelper craftingTracker) {
        ...
        for (GT_Hatch_Crafting_Integration_ME.PatternSlot slot : internalInventory) {
            if (slot == null) continue;
    ...
    @Override
    public Iterator<GT_Hatch_Crafting_Integration_ME.PatternSlot> inventories() {
    ...
    public static class PatternSlot implements IDualInputInventory {
        ...
        private final GT_Hatch_Crafting_Integration_ME.PatternSlot.SharedItemGetter sharedItemGetter;
        public PatternSlot(ItemStack pattern, World world, GT_Hatch_Crafting_Integration_ME.PatternSlot.SharedItemGetter getter) {
        ...
        public PatternSlot(ItemStack pattern, NBTTagCompound nbt, World world, GT_Hatch_Crafting_Integration_ME.PatternSlot.SharedItemGetter getter) {
            this.pattern = pattern;
            this.patternDetails = ((ICraftingPatternItem) Objects.requireNonNull(pattern.getItem()))
                .getPatternForItem(pattern, world);
            this.itemInventory = new ArrayList<>();
            ...
            for (int i = 0; i < inventoryCrafting.getSizeInventory(); ++i) {
                ...
                if (itemStack.getItem() instanceof ItemFluidPacket) { // insert fluid
                    ...
                    for (var fluid : fluidInventory) {
                        ...
                        if (MAX_IOPUT - fluidStack.amount < fluid.amount) {
                            // Overflow detected
                            errorIndex = i;
                            break;
                        }
                    ...
                    for (var item : itemInventory) {
                        ...
                        if (MAX_IOPUT - itemStack.stackSize < item.stackSize) {
                            // Overflow detected
                            errorIndex = i;
                            break;
                        }
